    ...
    <el-form ref="form" :model="form" label-width="160px" :rules="formRules">
      ...
      <el-row>
        ...
        <el-col :span="12">
          ...
          <el-button type="primary" plain class="test_btn" :loading="test_cam_loading" @click="showSetRedLightModal(form.middle_cam_name)">画线设置</el-button>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="8">
    ...
    onSubmit() {
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          axios.post('/set_middle_cam', reqData).then((res) => {
